...
public class flightData {
	...
	public flightData (ArrayList <airportObject> ports,ArrayList <airplaneObject> planes,ArrayList <flightData> flights,int originID ,int destinationID , String date,  String startTime ,String  landingTime ,int passengers , int planeID,boolean flightType,boolean addType)
	{
	...
	public void editME (ArrayList <airportObject> ports,ArrayList <airplaneObject> planes,ArrayList <flightData> flights,int originID ,int destinationID , String date,  String startTime ,String  landingTime ,int passengers , int planeID,boolean flightType)
	{
		if (checkConflict(originID, destinationID, flights, date, startTime, landingTime))
		{
			this.originID=originID;
